...
<!--      </div>-->
<!--      <div class="Bbox23">&lt;!&ndash; >버튼< &ndash;&gt;-->
<!--        <button id = "New Account" style = "width:80pt" v-on:click="btn_NewAccount">New Account</button>-->
<!--        &lt;!&ndash; ><input type="button" value="New Account" size=70 style = "width:80pt;height:16pt;text-align:center;">< &ndash;&gt;-->
<!--      </div>-->
<!--      <div class="BPad">-->
<!--      </div>-->
<!--    </div>-->
...
<!--      </div>-->
<!--      <div class="Bbox33">&lt;!&ndash; >버튼< &ndash;&gt;-->
<!--        <button id = "Find PW" style = "width:80pt" v-on:click="btn_FindPW">Find PW</button>-->
<!--        &lt;!&ndash; ><input type="button" value="Find PW" size=70 style = "width:80pt;height:16pt;text-align:center;">< &ndash;&gt;-->
<!--      </div>-->
<!--      <div class="BPad">-->
<!--      </div>-->
<!--    </div>-->
