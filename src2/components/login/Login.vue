...
<template>
    <div class="simpleLogin">
        ...
        <div class="Lbox11">
            ...
            <div class="Lbox">
                <input id="name" placeholder="Username" type="text" style="width:270px;">
            </div>
            ...
            <div class="Lbox">
                <button id = "New Account" style="width:140px;" v-on:click="btn_NewAccount">New Account</button>
            </div>
        </div>
        ...
        <div class="Lbox11">
            ...
            <div class="Lbox">
                <input id="pass" placeholder="Password" type="password" style="width:270px;">
            </div>
            ...
            <div class="Lbox">
                <button id = "Find PW" style="width:140px;" v-on:click="btn_FindPW">Find PW</button>
            </div>
        </div>
        ...
        <div class="Lbox12" style="padding:20px;">
            ...
            <div class="Lbox">
                <input type="button" value="Log In" style="width:140px; height:40px;"> 
            </div>
            ...
            <div class="Lbox">
                <a href="/login"><img src="../../assets/kakao.png" style= "width:140px; height:40px;"></a>
            </div>
